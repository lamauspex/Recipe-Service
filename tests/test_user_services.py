...
class TestAuthService:
    ...
    def test_password_hashing_too_long(self, auth_service):
    ...
    def test_create_tokens(self, auth_service, test_user_data):
    ...
    def test_get_user_from_token(self, auth_service, test_user_data):
...
class TestUserService:
    ...
    def test_get_user_by_id(self, user_service, user_data):
    ...
    def test_get_user_by_username(self, user_service, user_data):
    ...
    def test_get_user_by_email(self, user_service, user_data):
    ...
    def test_update_user_with_dict(self, user_service, user_data):
    ...
    def test_update_user_email_conflict(self, user_service, user_data):
    ...
    def test_get_users(self, user_service, user_data):
    ...
    def test_get_users_with_pagination(self, user_service, user_data):
    ...
    def test_get_active_users(self, user_service, user_data):
    ...
    def test_activate_user(self, user_service, user_data):
    ...
    def test_deactivate_user(self, user_service, user_data):
    ...
    def test_set_admin(self, user_service, user_data):
    ...
    def test_get_nonexistent_user_by_username(self, user_service):
        """Тест получения несуществующего пользователя по username"""
        user = user_service.get_user_by_username("nonexistent_user")
        assert user is None

    def test_get_nonexistent_user_by_email(self, user_service):
