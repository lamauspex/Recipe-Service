...
from backend.user_service.src.services.dto.requests import (
    UserListRequestDTO,
...
from backend.user_service.src.services.dto.responses import (
    UserListResponseDTO,
...
class AdminInterface(ABC):
    ...
    @abstractmethod
    async def log_login_attempt(self, request: LoginAttemptLogRequestDTO) -> LoginAttemptLogResponseDTO:
        """Логирование попытки входа"""
        pass

    @abstractmethod
    async def get_login_history(self, request: LoginHistoryRequestDTO) -> LoginHistoryResponseDTO:
        """Получение истории входов"""
        pass

    @abstractmethod
    async def get_login_statistics(self, request: LoginStatisticsRequestDTO) -> LoginStatisticsResponseDTO:
        """Получение статистики входов"""
        pass

    @abstractmethod
    async def get_failed_login_attempts(self, request: LoginStatisticsRequestDTO) -> FailedLoginAttemptsResponseDTO:
        """Получение неудачных попыток входа"""
        pass

    @abstractmethod
    async def get_suspicious_activity(self, request: LoginStatisticsRequestDTO) -> LoginStatisticsResponseDTO:
